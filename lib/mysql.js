...
MySQL.prototype.buildExpression = function(columnName, operator,
    operatorValue, propertyDefinition) {
  switch (operator) {
    // Note: We do not need cases for `ilike` and `nilike` for mysql.
    // This is because, "In MySQL, SQL patterns are case-insensitive by default. (https://dev.mysql.com/doc/refman/5.7/en/pattern-matching.html)"
    case 'like':
